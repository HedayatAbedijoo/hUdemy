...
pub fn create(
    ...
    let new_content = Content::new(name, module_address.clone(), url, timestamp, descritpion);
...
pub fn get_contents(module_address: &Address) -> ZomeApiResult<Vec<ZomeApiResult<GetEntryResult>>> {
...
pub fn update(
    ...
    content.descritpion = descritpion;
    content.name = name;
    content.url = url;
